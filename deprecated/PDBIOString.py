...
# MOD: Parse CONECT records
from bio.StructureBuilder import StructureBuilder  # To allow saving of chains, residues, etc..
from Bio.Data.IUPACData import atom_weights  # Allowed Elements

from bio.entity_func import get_parent_by_level
...
class PDBIOString(object):
    ...
    def set_structure(self, pdb_object):
        parent_struct = get_parent_by_level(pdb_object, level='S')
    ...
    def get_pdb_block(self, select=Select(), write_conects=False,
