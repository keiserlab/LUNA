...
Briefly, this means LUNA can be used in any manner without modification, with proper attribution. However, if the source code is modified for an application, this modified source must also be released under |license| so that the community may benefit.
