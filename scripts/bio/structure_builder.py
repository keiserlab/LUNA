...
BUG: The Residue, Chain from Bio.PDB have an error in
     Python 3 in comparative operations
"""
from bio.residue import myResidue as Residue
from bio.chain import myChain as Chain
