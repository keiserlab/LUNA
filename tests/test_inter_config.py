...
class InteractionConfigTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(config.params,
                         ['bsite_cutoff', 'cache_cutoff',
                          'max_an_ey_ang_ortho_multipolar_inter',
                          'max_an_ey_ang_para_multipolar_inter',
                          'max_cc_dist_amide_pi_inter',
                          'max_cc_dist_pi_pi_inter', 'max_da_dist_hb_inter',
                          'max_da_dist_whb_inter', 'max_dc_dist_whb_inter',
                          ...
                          'max_dist_hydrop_inter', 'max_dist_proximal',
                          'max_dist_repuls_inter',
                          'max_ha_dist_hb_inter', 'max_ha_dist_whb_inter',
